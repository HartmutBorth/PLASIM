...
!
       ...
       zcllhf(:,13)=zcllhf(:,1)
!
       call mpscgp(zclsst(:,0:13),ccsst(:,0:13),14)
       call mpscgp(zcltaux(:,0:13),cctaux(:,0:13),14)
       call mpscgp(zcltauy(:,0:13),cctauy(:,0:13),14)
       call mpscgp(zclevap(:,0:13),ccevap(:,0:13),14)
       call mpscgp(zclprl(:,0:13),ccprl(:,0:13),14)
       call mpscgp(zclprc(:,0:13),ccprc(:,0:13),14)
       call mpscgp(zclroff(:,0:13),ccroff(:,0:13),14)
       call mpscgp(zcliced(:,0:13),cciced(:,0:13),14)
       call mpscgp(zclsnow(:,0:13),ccsnow(:,0:13),14)
       call mpscgp(zclswr(:,0:13),ccswr(:,0:13),14)
       call mpscgp(zcllwr(:,0:13),cclwr(:,0:13),14)
       call mpscgp(zclshf(:,0:13),ccshf(:,0:13),14)
       call mpscgp(zcllhf(:,0:13),cclhf(:,0:13),14)
       call mpscgp(zlsm(:),ccls(:),1)
!
!     make clsst >= tfreeze
! 
       do jm=0,13
