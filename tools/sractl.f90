...
Character*255 filein, filedes,filesrv !filenames
!     external iargc
!==========================================================================
      narg=iargc()
